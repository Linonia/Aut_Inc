namespace Scripts.Logica
{
    public static class ParametriContratto
    {
        ...
        public static float PercentualeAnticipo { get; set; } = 0.20f;  // 20% all'inizio
        public static float PercentualeFinale { get; set; } = 0.20f;    // 20% alla fine
        ...
        public static int MinSettimaneDifficile { get; set; } = 4;
        public static int MaxSettimaneDifficile { get; set; } = 14;
